						...
						for( $dia = $dia_inicio; $dia <= $diasMes[$mes - 1]; $dia++ ){	
							...
							if(getdate($date->getTimestamp())['wday'] == 0){
								...
								$this->DateOfRequest[] = array(
										"inicio_dia" => date("Y/m/d H:i:s", mktime(0, 0, 0, $mes, $dia, $ano_inicio)),
										"fin_dia" => date("Y/m/d H:i:s", mktime(12, 0, 0, $mes, $dia, $ano_inicio)),
								); 
						...
						for( $mes = $mes_inicio; $mes <= $fin; $mes++ ){
							for( $dia = $dia_inicio; $dia <= $diasMes[$mes - 1]; $dia++){	
								...
								if(getdate($date->getTimestamp())['wday'] == 0){
									...
									$this->DateOfRequest[] = array(
											"inicio_dia" => date("Y/m/d H:i:s", mktime(0, 0, 0, $mes, $dia, $ano)),
											"fin_dia" => date("Y/m/d H:i:s", mktime(24, 0, 0, $mes, $dia, $ano)),
									); 
...
$llamada = new DiasNoHabiles('2012/02/02', '2013/07/30');
